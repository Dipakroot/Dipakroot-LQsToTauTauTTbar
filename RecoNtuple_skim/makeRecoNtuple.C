...
//added by Dipak
 ...
 std::sort(sortDiTauInfos.begin(), sortDiTauInfos.end(), SortDiTauPairs()); 
  ...
  sortedDiTaus= sortDiTauInfos.at(0);
    ...
    int tauId_1 = sortedDiTaus.index1_ ;
    int tauId_2 = sortedDiTaus.index2_ ;
    ...
    if(pairCharge==-1){
      ...
      _tauPt1.push_back(tree->tauPt_[tauId_1]);                                                                                                  
      _tauPhi1.push_back(tree->tauPhi_[tauId_1]);      
      _tauEta1.push_back(tree->tauEta_[tauId_1]);                                                           

      _tauPt2.push_back(tree->tauPt_[tauId_2]);
      _tauPhi2.push_back(tree->tauPhi_[tauId_2]);                                                    
      _tauEta2.push_back(tree->tauEta_[tauId_2]); 
